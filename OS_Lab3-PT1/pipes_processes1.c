...
// Credit to Professor Burge Zoom Recorded Lectures
// Credit to www.geeksforgeeks.com
...
{ 
    ...
    { 
        ...
        close(fd2[1]); // end of pipe 1 close writing
    ...
    { 
        ...
        close(fd1[0]); // Close reading end of the pipes 
